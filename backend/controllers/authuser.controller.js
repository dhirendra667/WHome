...
/**
 * @REGISTER
 * @ROUTE @POST {{URL}}/api/v1/authuser/register
 * @ACCESS Public
 */
  ...
  if (req.file) {
    try {
      const result = await cloudinary.uploader.upload(req.file.path, {
        folder: 'whome_avtar', // Save files in a folder named lms
        width: 250,
        height: 250,
...
/**
 * @LOGIN
 * @ROUTE @POST {{URL}}/api/v1/authuser/login
 * @ACCESS Public
 */
...
/**
 * @LOGOUT
 * @ROUTE @POST {{URL}}/api/v1/authuser/logout
 * @ACCESS Public
 */
 ...
 * @ROUTE @GET {{URL}}/api/v1/authuser/me
...
/**
 * @FORGOT_PASSWORD
 * @ROUTE @POST {{URL}}/api/v1/authuser/reset
 * @ACCESS Public
 */
...
/**
 * @RESET_PASSWORD
 * @ROUTE @POST {{URL}}/api/v1/authuser/reset/:resetToken
 * @ACCESS Public
 */
...
/**
 * @CHANGE_PASSWORD
 * @ROUTE @POST {{URL}}/api/v1/authuser/change-password
 * @ACCESS Private (Logged in users only)
 */
...
/**
 * @UPDATE_USER
 * @ROUTE @POST {{URL}}/api/v1/authuser/update/:id
